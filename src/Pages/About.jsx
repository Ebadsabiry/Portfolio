...
const AboutPage = () => {
  // Fixed values for stats
  const totalProjects = 3;
  const totalCertificates = 15;
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
I am a Computer Network and Telecommunications Engineering graduate with extensive experience in software development and UI/UX design. I specialize in crafting engaging digital experiences, designing intuitive interfaces, and delivering innovative solutions that seamlessly blend functionality and aesthetics.
            </p>
            ...
            >
              ...
              <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
                "Leveraging AI to enhance creativity and professional expertise, not replace it."
              </blockquote>
            </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1X4UpOrEKb0hqysCpra_tV1WpGmWWLJ5Q/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
